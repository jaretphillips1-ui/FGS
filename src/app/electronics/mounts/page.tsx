...
const ITEMS: Item[] = [
  { name: "Graph mount (deck/rail)", notes: "Later: exact mount system.", status: "wishlist" },
  { name: "Pole mount (live sonar)", notes: "Manual / quick-stow pole.", status: "wishlist" },
  { name: "Transducer mount hardware", notes: "Hull/pole options.", status: "wishlist" },
];
  ...
  return (
    <main className="max-w-5xl mx-auto p-6 space-y-6">
      <header className="space-y-2">
        <h1 className="text-2xl font-semibold">Electronics • Mounts</h1>
        <p className="text-sm text-gray-600">Mounts and rigging building blocks.</p>
      </header>
            ...
            {owned.map((x,i)=>(
              <div key={i} className="border rounded p-4 bg-white">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-2"><Pill>Mounts</Pill><StatusPill s={x.status}/></div>
                </div>
