...
const ITEMS: Item[] = [
  { name: "Through-hull wiring / bulkhead", notes: "Clean entry/exit points.", status: "wishlist" },
  { name: "Quick disconnects", notes: "Serviceability + transport.", status: "wishlist" },
  { name: "Heat shrink + connectors", notes: "Waterproofing + clean wiring.", status: "wishlist" },
];
  ...
  return (
    <main className="max-w-5xl mx-auto p-6 space-y-6">
      <header className="space-y-2">
        <h1 className="text-2xl font-semibold">Electronics • Wiring</h1>
        <p className="text-sm text-gray-600">Wiring and tidy install parts.</p>
      </header>
            ...
            {owned.map((x,i)=>(
              <div key={i} className="border rounded p-4 bg-white">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-2"><Pill>Wiring</Pill><StatusPill s={x.status}/></div>
                </div>
