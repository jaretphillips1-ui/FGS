...
const ITEMS: Item[] = [
  { name: "LiFePO4 battery (12V/24V)", notes: "Later: exact brand + Ah + charger.", status: "wishlist" },
  { name: "Breaker / fuse protection", notes: "Safety + serviceability.", status: "wishlist" },
  { name: "Power distribution block", notes: "Clean wiring + tidy installs.", status: "wishlist" },
];
  ...
  return (
    <main className="max-w-5xl mx-auto p-6 space-y-6">
      <header className="space-y-2">
        <h1 className="text-2xl font-semibold">Electronics • Power</h1>
        <p className="text-sm text-gray-600">Power system building blocks. Later: your exact kayak build components.</p>
      </header>
            ...
            {owned.map((x,i)=>(
              <div key={i} className="border rounded p-4 bg-white">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-2"><Pill>Power</Pill><StatusPill s={x.status}/></div>
                </div>
