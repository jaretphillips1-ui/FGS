...
const ITEMS: Item[] = [
  { name: "Terminal organizer (small compartments)", notes: "Hooks, weights, swivels, snaps.", status: "wishlist" },
  { name: "Soft plastic storage (binder / bags)", notes: "Organize by category.", status: "wishlist" },
  { name: "Jig box / skirted jig storage", notes: "Keeps skirts from tangling.", status: "wishlist" },
];
  ...
  return (
    <main className="max-w-5xl mx-auto p-6 space-y-6">
      <header className="space-y-2">
        <h1 className="text-2xl font-semibold">Toolbox • Organizers</h1>
        <p className="text-sm text-gray-600">Storage and organization items.</p>
      </header>
            ...
            {owned.map((x,i)=>(
              <div key={i} className="border rounded p-4 bg-white">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-2"><Pill>Organizers</Pill><StatusPill s={x.status}/></div>
                </div>
