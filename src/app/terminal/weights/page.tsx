...
const ITEMS: Item[] = [
  { name: "Bullet weights (worm)", notes: "Later: tungsten/lead, sizes, pegging.", status: "wishlist" },
  { name: "Drop-shot weights", notes: "Later: shapes + sizes.", status: "wishlist" },
  { name: "Ned heads (weights live under Jigheads too)", notes: "We can duplicate/relate later.", status: "wishlist" },
];
  ...
  return (
    <main className="max-w-5xl mx-auto p-6 space-y-6">
      <header className="space-y-2">
        <h1 className="text-2xl font-semibold">Terminal • Weights</h1>
        <p className="text-sm text-gray-600">Seed categories for weights. Next: exact sizes, material, brand.</p>
      </header>
            ...
            {owned.map((x,i)=>(
              <div key={i} className="border rounded p-4 bg-white">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-2"><Pill>Weights</Pill><StatusPill s={x.status}/></div>
                </div>
