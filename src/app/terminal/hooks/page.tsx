...
const ITEMS: Item[] = [
  { brand: "BKK", model: "Wide Gap / Worm hook families (catalog anchor)", notes: "Good base for EWG / plastics.", status: "wishlist", sourceUrl: SOURCES.bkkAmericasCatalog },
  { brand: "Owner", model: "Hook lineup (anchor)", notes: "Later: pick exact models + sizes.", status: "wishlist", sourceUrl: SOURCES.owner },
  { brand: "Gamakatsu", model: "Hook lineup (anchor)", notes: "Later: exact models + sizes.", status: "wishlist", sourceUrl: SOURCES.gamakatsu },
];
