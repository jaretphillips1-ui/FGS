...
const ITEMS: Item[] = [
  { name: "Barrel swivels", notes: "Later: sizes + strength ratings.", status: "wishlist" },
  { name: "Snap swivels", notes: "Quick change leaders/lures (species dependent).", status: "wishlist" },
  { name: "Tactical snaps", notes: "More compact, higher strength; later add brands.", status: "wishlist" },
];
  ...
  return (
    <main className="max-w-5xl mx-auto p-6 space-y-6">
      <header className="space-y-2">
        <h1 className="text-2xl font-semibold">Terminal • Swivels &amp; Snaps</h1>
        <p className="text-sm text-gray-600">Seeded categories. Next: sizes, strength, use-cases.</p>
      </header>
            ...
            {owned.map((x,i)=>(
              <div key={i} className="border rounded p-4 bg-white">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-2"><Pill>Swivels/Snaps</Pill><StatusPill s={x.status}/></div>
                </div>
