...
const SOURCES = { sufixCanada: "https://www.rapala.ca/ca_en/sufix" };

const ITEMS: Item[] = [
  { brand: "Sufix", model: "Advance Fluorocarbon Leader", notes: "Leader material option for braid-to-leader setups.", status: "wishlist", sourceUrl: SOURCES.sufixCanada },
  { brand: "Sufix", model: "Leader families (browse)", notes: "Catalog anchor for exact lb tests later.", status: "wishlist", sourceUrl: SOURCES.sufixCanada },
];
  ...
  return (
    <main className="max-w-5xl mx-auto p-6 space-y-6">
      <header className="space-y-2">
        <h1 className="text-2xl font-semibold">Line • Leader</h1>
        <p className="text-sm text-gray-600">Leader materials and anchors. Later: lb tests, leader length presets, knots.</p>
            ...
            {owned.map((x,i)=>(
              <div key={i} className="border rounded p-4 bg-white">
                <div className="flex flex-wrap items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-2"><Pill>Leader</Pill><StatusPill s={x.status}/></div>
                </div>
