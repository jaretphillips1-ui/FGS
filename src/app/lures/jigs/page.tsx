...
const ITEMS: Item[] = [
  { name: "Casting jigs", notes: "Later: weights + trailers.", status: "wishlist" },
  { name: "Swim jigs", notes: "Later: head style + skirt colors.", status: "wishlist" },
  { name: "Finesse jigs", notes: "Later: small profile options.", status: "wishlist" },
];
  ...
  return (
    <main className="max-w-5xl mx-auto p-6 space-y-6">
      <header className="space-y-2">
        <h1 className="text-2xl font-semibold">Lures • Jigs</h1>
        <p className="text-sm text-gray-600">Jig categories now, detailed SKUs later.</p>
      </header>
            ...
            {owned.map((x,i)=>(
              <div key={i} className="border rounded p-4 bg-white">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-2"><Pill>Jigs</Pill><StatusPill s={x.status}/></div>
                </div>
